...
public class JdbcUtil {
     ...
     final String URL="jdbc:mysql://localhost:3306/skk";
     final String USERNAME="root";
     final String PASSWORD="123asd.";
    ...
    static{
        try {
            Class.forName("com.mysql.jdbc.Driver");//算是一个驱动，获取驱动的全类名
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        }
    }
//--------------通过全局作用域对象的到Connection--------start
